...
jQuery(function($) {'use strict';
  ...
  //goto TOP Button
    ...
    // Get all job cards and handle clicks
    ...
    function showModal(jobTitle) {
        $(modalTitle).text(jobTitle);
        
        // Hide all job content divs
        $('.job-content').hide();
        
        // Show the relevant content based on job title
        let contentId = '';
        switch(jobTitle.toLowerCase()) {
            case 'botanist':
                contentId = 'botanist-content';
                break;
            case 'herbal research scientist':
                contentId = 'scientist-content';
                break;
            case 'herbal pharmacist':
                contentId = 'pharmacist-content';
                break;
        }
