...
!(function (n, t, e) {
    ...
    function g(n) {
        ...
        return (
            ...
            p("Geocoder").geocode(n, function (n, e) {
                e === k.GeocoderStatus.OK ? t.resolve(n[0].geometry.location) : t.reject();
            }),
            t
        );
    }
    ...
    function x(n, t) {
        return R(n) ? new k.LatLng(n[0], n[1]) : !t || !n || n instanceof k.LatLng ? n : new k.LatLng(n.lat, n.lng);
    }
    function P(n, t) {
        return R(n) ? new k.LatLngBounds({ lat: n[2], lng: n[3] }, { lat: n[0], lng: n[1] }) : t && !n.getCenter ? new k.LatLngBounds({ lat: n.south, lng: n.west }, { lat: n.north, lng: n.east }) : n;
    }
    function b(t, o) {
        function r() {
            function n(n) {
        ...
        var i = k.OverlayView,
            u = n(e.createElement("div")).css({ border: "none", borderWidth: 0, position: "absolute" }).append(o.content);
        return (o = j({ x: 0, y: 0 }, o)), o.position ? (o.position = x(o.position, !0)) : o.bounds && (o.bounds = P(o.bounds, !0)), (r.prototype = new i()), new r();
    }
    function M(n) {
        function t() {
            var n = this;
            return (n.onAdd = n.onRemove = n.draw = function () {}), k.OverlayView.call(n);
        }
    ...
    function C(n, t) {
        function e() {
            var t = l("Circle", { center: n.getCenter(), radius: 1.15 * c(n.getCenter(), n.getBounds().getNorthEast()) });
            return t.getBounds();
        }
        function i(n) {
        ...
        function u() {
            ...
            (p = "" + d),
                ...
                p !== g &&
                    ...
                    h(v(E), function (n) {
                        y[n] || (E[n].overlay.setMap(null), delete E[n]);
                    }),
                    x.length &&
                        h(T, function (n) {
                            n(x);
        ...
        function s() {
            k.event.addListener(n, "zoom_changed", a), k.event.addListener(n, "bounds_changed", a), u();
        }
        var f,
            p,
            g,
    ...
    function T(t, e) {
                ...
                n.each(t, function (n, t) {
                    h(e, function (e) {
                        var a = e instanceof B,
                            s = a || e instanceof k.OverlayView,
                            f = s ? e.$.get(0) : e;
                        k.event["add" + (s ? "Dom" : "") + "Listener" + (i ? "Once" : "")](f, n, function (n) {
                            h(t, function (t) {
                                if (A(t))
        ...
        function g(n) {
            return function () {
                ...
                return (P = P.then(function (e) {
                    return A(t[0])
                        ? S(t[0].call(c(), e)).then(function (e) {
        ...
        (M.map = g(function (n) {
            ...
            (M.kmllayer = g(
                f(function (n) {
                    return (n = o(n)), (n.map = v), S(l("KmlLayer", n));
                })
            )),
            (M.rectangle = g(
                f(function (n) {
            ...
            (M.route = g(function (n) {
                ...
                return (
                    (n = o(n)),
                    (n.origin = x(n.origin)),
                    (n.destination = x(n.destination)),
                    p("DirectionsService").route(n, function (n, e) {
                        y.push(n), t.resolve(e === k.DirectionsStatus.OK ? n : !1);
                    }),
                    t
                );
            })),
                            ...
                            h(t, function (t) {
                                t &&
                                    (t.getPosition && t.getPosition()
                                        ...
                                        ? h(t.getPaths().getArray(), function (t) {
                                              h(t.getArray(), function (t) {
                                                  n.extend(t);
                                              });
                                          })
                                        : t.getPath && t.getPath()
                                        ? h(t.getPath().getArray(), function (t) {
                                              n.extend(t);
                                          })
                                        : t.getCenter && t.getCenter() && n.extend(t.getCenter()));
                            });
                    }),
                    n.isEmpty() || v.fitBounds(n),
                    !0
                );
            })),
            (M.wait = function (n) {
            ...
            (M.then = function (n) {
                A(n) &&
                    (P = P.then(function (t) {
                        return S(n.call(c(), t)).then(function (n) {
                            return i(n) ? t : n;
                        });
                    }));
            }),
            d("on once", function (n, t) {
                M[n] = function () {
                    var n = arguments[0];
                    n &&
                        ("string" == typeof n && ((n = {}), (n[arguments[0]] = r(arguments, 1))),
                        P.then(function (e) {
                            if (e) {
                                if (e instanceof C)
                                    return (
            ...
            s(function () {
                (t.google && t.google.maps) || D === !1
                    ...
                    : ((t[i] = function () {
                      ...
                      (o.src = "https://maps.googleapis.com/maps/api/js?callback=" + i + (D ? "&" + ("string" == typeof D ? D : f(D)) : "")),
                      n("head").append(o));
            }),
            r.promise()
        );
        ...
        (n.fn.gmap3 = function (e) {
            ...
            return (
                ...
                this.each(function () {
                    var t = n(this),
                        r = t.data("gmap3");
                    r || ((r = new T(t, e)), t.data("gmap3", r)), o.push(r);
                }),
                new E(this, o)
            );
        });
