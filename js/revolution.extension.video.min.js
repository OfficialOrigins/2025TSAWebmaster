...
!(function (e) {
    ...
    jQuery.extend(!0, a, {
        preLoadAudio: function (e, t) {
            e.find(".tp-audiolayer").each(function () {
                ...
                0 === e.find("audio").length &&
                    ...
                    ("auto" == i.pre || "canplaythrough" == i.pre || "canplay" == i.pre || "progress" == i.pre) && (void 0 === t.audioqueue && (t.audioqueue = []), t.audioqueue.push(i), a.manageVideoLayer(e, t)));
            });
        },
        ...
        resetVideo: function (e, d) {
            switch (e.data("videotype")) {
                case "youtube":
                    ...
                    0 == e.find(".tp-videoposter").length && punchgs.TweenLite.to(e.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
                    break;
                case "vimeo":
                ...
                case "html5":
                    ...
                    var s = "html5" == e.data("audio") ? "audio" : "video",
                        l = e.find(s),
                        u = l[0];
                    if ((punchgs.TweenLite.to(l, 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut }), "on" == e.data("forcerewind") && !e.hasClass("videoisplaying")))
                        try {
                            var o = t(e.data("videostartat"));
                            u.currentTime = -1 == o ? 0 : o;
                        } catch (r) {}
                    ("mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || d.globalmute === !0) && (u.muted = !0);
            }
        },
        ...
        prepareCoveredVideo: function (e, t, i) {
            var d = i.find("iframe, video"),
                ...
                p = (l / s) * 100;
            s > l
                ? punchgs.TweenLite.to(d, 0.001, { height: u + "%", width: "100%", top: -(u - 100) / 2 + "%", left: "0px", position: "absolute" })
                : punchgs.TweenLite.to(d, 0.001, { width: p + "%", height: "100%", left: -(p - 100) / 2 + "%", top: "0px", position: "absolute" }),
                d.hasClass("resizelistener") ||
                    (d.addClass("resizelistener"),
                    jQuery(window).resize(function () {
                        clearTimeout(d.data("resizelistener")),
                            d.data(
                                "resizelistener",
                                setTimeout(function () {
        ...
        manageVideoLayer: function (e, o, n, s) {
            ...
            switch ((e.data("videotype", k), x)) {
                case "html5":
                    ...
                    "auto" == c && (o.mediapreload = !0),
                        void 0 != f && "firefox" == a.get_browser().toLowerCase() && (L = L + '<source src="' + f + '" type="video/webm" />'),
                        void 0 != g && (L = L + '<source src="' + g + '" type="video/mp4" />'),
                        void 0 != m && (L = L + '<source src="' + m + '" type="video/ogg" />'),
                        (L = L + "</" + T + ">");
                    var V = "";
                    ("true" === y || y === !0) && (V = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'),
                        "controls" == h &&
                            (L +=
                                ...
                                V +
                                "</div>"),
                        e.data("videomarkup", L),
                        e.append(L),
                        ((i && 1 == e.data("disablevideoonmobile")) || a.isIE(8)) && e.find(T).remove(),
                        e.find(T).each(function (t) {
                            var i = this,
                                r = jQuery(this);
            ...
            if (void 0 != e.data("videoposter") && e.data("videoposter").length > 2 && !_)
                    ...
                    0 == e.find("iframe").length &&
                        e.find(".tp-videoposter").click(function () {
                            if ((a.playVideo(e, o), i)) {
                                ...
                                punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                                    punchgs.TweenLite.to(e.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
                            }
                        });
            else {
                if (i && 1 == e.data("disablevideoonmobile")) return !1;
            ...
            "none" != e.data("dottedoverlay") && void 0 != e.data("dottedoverlay") && 1 != e.find(".tp-dottedoverlay").length && e.append('<div class="tp-dottedoverlay ' + e.data("dottedoverlay") + '"></div>'),
                e.addClass("HasListener"),
                1 == e.data("bgvideo") && punchgs.TweenLite.set(e.find("video, iframe"), { autoAlpha: 0 });
        },
    });
    var d = function (e, t, a) {
        ...
        r = function (e, d, r) {
            ...
            if ((l.attr("id", v), r && e.data("startvideonow", !0), 1 !== e.data("videolistenerexist")))
                switch (e.data("videotype")) {
                    case "youtube":
                            ...
                            events: {
                                onStateChange: function (i) {
                                    ...
                                    if (i.data == YT.PlayerState.PLAYING)
                                        punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                                            punchgs.TweenLite.to(e.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut }),
                                            "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || d.globalmute === !0 ? m.mute() : (m.unMute(), m.setVolume(parseInt(e.data("volume"), 0) || 75)),
                                            (d.videoplaying = !0),
                                            u(e, d),
                                            g ? d.c.trigger("stoptimer") : (d.videoplaying = !1),
                                            d.c.trigger("revolution.slide.onvideoplay", o(m, "youtube", e.data())),
                                            a.toggleState(e.data("videotoggledby"));
                                    else {
                                        if (0 == i.data && c) {
                                            var v = t(e.data("videostartat"));
                                            -1 != v && m.seekTo(v), m.playVideo(), a.toggleState(e.data("videotoggledby"));
                                        }
                                        !l &&
                                            (0 == i.data || 2 == i.data) &&
                                            "on" == e.data("showcoveronpause") &&
                                            e.find(".tp-videoposter").length > 0 &&
                                            (punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                                            punchgs.TweenLite.to(e.find("iframe"), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })),
                                            -1 != i.data &&
                                                3 != i.data &&
                                                ((d.videoplaying = !1),
                                                (d.tonpause = !1),
                                                ...
                                                d.c.trigger("revolution.slide.onvideostop", o(m, "youtube", e.data())),
                                                (void 0 == d.currentLayerVideoIsPlaying || d.currentLayerVideoIsPlaying.attr("id") == e.attr("id")) && a.unToggleState(e.data("videotoggledby"))),
                                            0 == i.data && 1 == e.data("nextslideatend")
                                                ? (n(), e.data("nextslideatend-triggered", 1), d.c.revnext(), p(e, d))
                                                : (p(e, d),
                                                  (d.videoplaying = !1),
                                                  r.trigger("starttimer"),
                                                  d.c.trigger("revolution.slide.onvideostop", o(m, "youtube", e.data())),
                                ...
                                onReady: function (a) {
                                    ...
                                    if (
                                        ...
                                        void 0 != d && a.target.setPlaybackRate(parseFloat(d)),
                    ...
                    case "vimeo":
                        ...
                        x.addEvent("ready", function () {
                            if (
                                (e.addClass("rs-apiready"),
                                x.addEvent("play", function (t) {
                                    e.data("nextslidecalled", 0),
                                        punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                                        punchgs.TweenLite.to(e.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut }),
                                        d.c.trigger("revolution.slide.onvideoplay", o(x, "vimeo", e.data())),
                                        (d.videoplaying = !0),
                                        u(e, d),
                                        g ? d.c.trigger("stoptimer") : (d.videoplaying = !1),
                                        "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || d.globalmute === !0 ? x.api("setVolume", "0") : x.api("setVolume", parseInt(e.data("volume"), 0) / 100 || 0.75),
                                        a.toggleState(e.data("videotoggledby"));
                                }),
                                x.addEvent("playProgress", function (a) {
                                    var i = t(e.data("videoendat"));
                                    if ((e.data("currenttime", a.seconds), 0 != i && Math.abs(i - a.seconds) < 0.3 && i > a.seconds && 1 != e.data("nextslidecalled")))
                                        if (c) {
                                            x.api("play");
                                            var o = t(e.data("videostartat"));
                                            -1 != o && x.api("seekTo", o);
                                ...
                                x.addEvent("finish", function (t) {
                                    p(e, d),
                                        ...
                                        d.c.trigger("revolution.slide.onvideostop", o(x, "vimeo", e.data())),
                                        1 == e.data("nextslideatend") && (e.data("nextslideatend-triggered", 1), d.c.revnext()),
                                        (void 0 == d.currentLayerVideoIsPlaying || d.currentLayerVideoIsPlaying.attr("id") == e.attr("id")) && a.unToggleState(e.data("videotoggledby"));
                                }),
        ...
        l = function (e, r, l) {
            ...
            if (
                ((m = "loop" == m || "loopandnoslidestop" == m),
                f.data("metaloaded", 1),
                void 0 == c.attr("control") &&
            ...
            void 0 != b &&
                ...
                d(g, "timeupdate", function () {
                    var a = (100 / g.duration) * g.currentTime,
                        ...
                        d = g.currentTime;
                    if ((void 0 != T && (T.value = a), 0 != i && -1 != i && Math.abs(i - d) <= 0.3 && i > d && 1 != e.data("nextslidecalled")))
                        if (m) {
                            g.play();
                            var o = t(e.data("videostartat"));
                            -1 != o && (g.currentTime = o);
                ...
                d(g, "play", function () {
                    ...
                    u(e, r),
                        y && "audio" != i
                            ? ((r.videoplaying = !0), r.c.trigger("stoptimer"), r.c.trigger("revolution.slide.onvideoplay", o(g, "html5", e.data())))
                            : ((r.videoplaying = !1), "audio" != i && r.c.trigger("starttimer"), r.c.trigger("revolution.slide.onvideostop", o(g, "html5", e.data()))),
                        punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                        punchgs.TweenLite.to(e.find(i), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
                ...
                d(g, "pause", function () {
                    ...
                    !i &&
                        ...
                        (punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find(t), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })),
                        e.removeClass("videoisplaying"),
                        (r.videoplaying = !1),
                        p(e, r),
                        "audio" != t && r.c.trigger("starttimer"),
                        r.c.trigger("revolution.slide.onvideostop", o(g, "html5", e.data()));
                    var d = e.find(".tp-vid-play-pause")[0];
                ...
                d(g, "ended", function () {
                    n(),
                        ...
                        (r.videoplaying = !1),
                        p(e, r),
                        "audio" != v && r.c.trigger("starttimer"),
                        r.c.trigger("revolution.slide.onvideostop", o(g, "html5", e.data())),
                        1 == e.data("nextslideatend") &&
                            (1 == !r.just_called_nextslide_at_htmltimer && (e.data("nextslideatend-triggered", 1), r.c.revnext(), (r.just_called_nextslide_at_htmltimer = !0)),
                            setTimeout(function () {
                                r.just_called_nextslide_at_htmltimer = !1;
                            }, 1500)),
                        e.removeClass("videoisplaying");
