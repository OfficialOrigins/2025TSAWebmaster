    ...
    var o = function (t, o, a, i) {
        ...
        a = function (t, e, o, a, i) {
            ...
            (e.duringslidechange = !0),
                (e.testanims = !1),
                1 == e.testanims &&
                    ((e.nexttesttransform = void 0 === e.nexttesttransform ? 34 : e.nexttesttransform + 1),
                    (e.nexttesttransform = e.nexttesttransform > 70 ? 0 : e.nexttesttransform),
                    (o = y[e.nexttesttransform][0]),
                    console.log(o + "  " + e.nexttesttransform + "  " + y[e.nexttesttransform][1] + "  " + y[e.nexttesttransform][2])),
                ...
                "random" == o && ((o = Math.round(Math.random() * y.length - 1)), o > y.length - 1 && (o = y.length - 1)),
        ...
        n = function (t, e, n, r, s, l, d, h, f) {
                ...
                t.find(".slot-circle-wrapper").each(function (t) {
                    if (r > t) {
                        var a = jQuery(this),
                            ...
                            m = { scale: 1, transformOrigo: "50% 50%", width: c + "px", height: d + "px", top: w + "px", left: v + "px", borderRadius: g },
                            x = { scale: 1, top: h / 2 - d / 2, left: l / 2 - c / 2, ease: i },
                            y = 31 == o ? u : 32 == o ? u : u,
                            T = 33 == o ? p : 34 == o ? p + l / 2 : p,
                            z = { width: l, height: h, autoAlpha: 1, top: y + "px", position: "absolute", left: T + "px" },
                            L = { top: u + "px", left: p + "px", ease: i },
                            b = e,
                            D = 0;
                        f.add(punchgs.TweenLite.fromTo(a, b, m, x), D), f.add(punchgs.TweenLite.fromTo(n, b, z, L), D), f.add(punchgs.TweenLite.fromTo(a, 0.001, { autoAlpha: 0 }, { autoAlpha: 1 }), 0);
                    }
                });
            }
            var p = l.index(),
            ...
            (y = "default" === y ? v[11] : "random" === y ? Math.round(1e3 * Math.random() + 300) : void 0 != y ? parseInt(y, 0) : v[11]),
                ...
                (r.slots = void 0 == r.slots || "default" == r.slots ? v[12] : "random" == r.slots ? Math.round(12 * Math.random() + 4) : r.slots),
                (r.slots = r.slots < 1 ? ("boxslide" == e ? Math.round(6 * Math.random() + 3) : "flyin" == e ? Math.round(4 * Math.random() + 1) : r.slots) : r.slots),
                ...
                11 != t && (null != v[7] && o(h, r, v[7], v[5]), null != v[6] && o(d, r, v[6], v[5])),
                f.add(punchgs.TweenLite.set(d.find(".defaultvid"), { y: 0, x: 0, top: 0, left: 0, scale: 1 }), 0),
                f.add(punchgs.TweenLite.set(h.find(".defaultvid"), { y: 0, x: 0, top: 0, left: 0, scale: 1 }), 0),
                f.add(punchgs.TweenLite.set(d.find(".defaultvid"), { y: "+0%", x: "+0%" }), 0),
                f.add(punchgs.TweenLite.set(h.find(".defaultvid"), { y: "+0%", x: "+0%" }), 0),
                f.add(punchgs.TweenLite.set(d, { autoAlpha: 1, y: "+0%", x: "+0%" }), 0),
                f.add(punchgs.TweenLite.set(h, { autoAlpha: 1, y: "+0%", x: "+0%" }), 0),
                f.add(punchgs.TweenLite.set(d.parent(), { backgroundColor: "transparent" }), 0),
                f.add(punchgs.TweenLite.set(h.parent(), { backgroundColor: "transparent" }), 0);
            ...
            if (4 == t || 5 == t) {
                ...
                h.find(".slotslide").each(function (e) {
                    ...
                    5 == t && (a = ((r.slots - e - 1) * k) / r.slots / 1.5),
                        j.add(punchgs.TweenLite.to(o, 3 * k, { transformPerspective: 600, force3D: "auto", top: 0 + r.height, opacity: 0.5, rotation: r.rotate, ease: T, delay: a }), 0),
                        f.add(j, 0);
                }),
                    d.find(".slotslide").each(function (e) {
                        var o = jQuery(this),
                            a = (e * k) / r.slots;
                        5 == t && (a = ((r.slots - e - 1) * k) / r.slots / 1.5), j.add(punchgs.TweenLite.from(o, 3 * k, { top: 0 - r.height, opacity: 0.5, rotation: r.rotate, force3D: "auto", ease: punchgs.eo, delay: a }), 0), f.add(j, 0);
                    });
            }
            if (6 == t) {
            ...
            if (7 == t) {
                ...
                setTimeout(function () {
                    ...
                    h.find(".slotslide").each(function () {
                        ...
                        j.add(
                            punchgs.TweenLite.to(t, y / 1e3, { left: 0 - r.slotw / 2 + "px", top: 0 - r.height / 2 + "px", width: 2 * r.slotw + "px", height: 2 * r.height + "px", opacity: 0, rotation: r.rotate, force3D: "auto", ease: T }),
                            0
                        ),
                            f.add(j, 0);
                    }),
                    d.find(".slotslide").each(function (t) {
                        ...
                        j.add(
                            punchgs.TweenLite.fromTo(
                                ...
                                { left: 0 - t * r.slotw + "px", ease: z, force3D: "auto", top: "0px", width: r.width, height: r.height, opacity: 1, rotation: 0, delay: 0.1 }
                            ),
                            0
                        ),
                            f.add(j, 0);
            ...
            if (8 == t) {
                ...
                h.find(".slotslide").each(function () {
                    var t = jQuery(this).find("div");
                    j.add(punchgs.TweenLite.to(t, y / 1e3, { left: 0 - r.width / 2 + "px", top: 0 - r.sloth / 2 + "px", width: 2 * r.width + "px", height: 2 * r.sloth + "px", force3D: "auto", ease: T, opacity: 0, rotation: r.rotate }), 0),
                        f.add(j, 0);
                }),
                    d.find(".slotslide").each(function (t) {
                        var e = jQuery(this).find("div");
                        j.add(
                            punchgs.TweenLite.fromTo(
                                ...
                                { left: "0px", top: 0 - t * r.sloth + "px", width: d.find(".defaultimg").data("neww") + "px", height: d.find(".defaultimg").data("newh") + "px", opacity: 1, ease: z, rotation: 0 }
                            ),
                            0
                        ),
                            f.add(j, 0);
            ...
            if (27 == t || 28 == t || 29 == t || 30 == t) {
                ...
                (_[q] = "0px"),
                    ...
                    (N[q] = X),
                    (R[q] = Y),
                    P.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'),
                    f.add(punchgs.TweenLite.fromTo(h, y / 1e3, _, C), 0),
                    f.add(punchgs.TweenLite.fromTo(d.find(".defaultimg"), y / 2e3, V, Z), y / 2e3),
                    f.add(punchgs.TweenLite.fromTo(P, y / 1e3, H, J), 0),
                    f.add(punchgs.TweenLite.fromTo(P.find(".slotslide div"), y / 1e3, N, R), 0);
            }
            if (31 == t || 32 == t || 33 == t || 34 == t) {
                ...
                (mas = B - B / 5),
                    ...
                    f.add(punchgs.TweenLite.fromTo(h, B - 0.2 * B, { y: 0, x: 0 }, { y: ty, x: tx, ease: z }), 0.2 * B),
                    f.add(punchgs.TweenLite.fromTo(d, B, { y: fy, x: fx }, { y: "0%", x: "0%", ease: T }), 0),
                    d.find(".slot").remove(),
            ...
            if (11 == t) {
                ...
                switch (m) {
                    ...
                    case 1:
                        f.add(punchgs.TweenLite.fromTo(d, y / 1e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: T }), 0),
                            f.add(punchgs.TweenLite.fromTo(h, y / 1e3, { autoAlpha: 1 }, { autoAlpha: 0, force3D: "auto", ease: T }), 0);
                        break;
                    case 2:
                    case 3:
                    case 4:
                        f.add(punchgs.TweenLite.set(h.parent(), { backgroundColor: E, force3D: "auto" }), 0),
                            f.add(punchgs.TweenLite.set(d.parent(), { backgroundColor: "transparent", force3D: "auto" }), 0),
                            f.add(punchgs.TweenLite.to(h, y / 2e3, { autoAlpha: 0, force3D: "auto", ease: T }), 0),
                            f.add(punchgs.TweenLite.fromTo(d, y / 2e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: T }), y / 2e3);
                }
            ...
            if (26 == t) {
                ...
                (y = 0),
                    f.add(punchgs.TweenLite.fromTo(d, y / 1e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: T }), 0),
                    f.add(punchgs.TweenLite.to(h, y / 1e3, { autoAlpha: 0, force3D: "auto", ease: T }), 0),
                    f.add(punchgs.TweenLite.set(d.find(".defaultimg"), { autoAlpha: 1 }), 0),
                    f.add(punchgs.TweenLite.set(h.find("defaultimg"), { autoAlpha: 1 }), 0);
            }
            if (12 == t || 13 == t || 14 == t || 15 == t) {
                ...
                var F = r.width,
                    ...
                    ot = y / 1e3,
                    at = ot;
                ("fullwidth" == r.sliderLayout || "fullscreen" == r.sliderLayout) && ((F = K.width()), (G = K.height())),
                    12 == t ? (U = F) : 15 == t ? (U = 0 - F) : 13 == t ? (W = G) : 14 == t && (W = 0 - G),
                    1 == m && ($ = 0),
                    2 == m && ($ = 0),
                    3 == m && (ot = y / 1300),
                    (4 == m || 5 == m) && (tt = 0.6),
                    6 == m && (tt = 1.4),
                    (5 == m || 6 == m) && ((et = 1.4), ($ = 0), (F = 0), (G = 0), (U = 0), (W = 0)),
                    6 == m && (et = 0.6);
                7 == m && ((F = 0), (G = 0));
                ...
                if (
                    ...
                    8 == m
                        ? (f.add(punchgs.TweenLite.set(l, { zIndex: 20 }), 0),
                          ...
                          f.add(punchgs.TweenLite.set(it, { left: 0, top: 0, scale: 1, opacity: 1, rotation: 0, ease: T, force3D: "auto" }), 0))
                        : f.add(punchgs.TweenLite.from(it, ot, { left: U, top: W, scale: et, opacity: $, rotation: r.rotate, ease: T, force3D: "auto" }), 0),
                    (4 == m || 5 == m) && ((F = 0), (G = 0)),
                    1 != m)
                )
                    switch (t) {
                        case 12:
                            f.add(punchgs.TweenLite.to(nt, at, { left: 0 - F + "px", force3D: "auto", scale: tt, opacity: $, rotation: r.rotate, ease: z }), 0);
                            break;
                        case 15:
                            f.add(punchgs.TweenLite.to(nt, at, { left: F + "px", force3D: "auto", scale: tt, opacity: $, rotation: r.rotate, ease: z }), 0);
                            break;
                        case 13:
                            f.add(punchgs.TweenLite.to(nt, at, { top: 0 - G + "px", force3D: "auto", scale: tt, opacity: $, rotation: r.rotate, ease: z }), 0);
                            break;
                        case 14:
                            f.add(punchgs.TweenLite.to(nt, at, { top: G + "px", force3D: "auto", scale: tt, opacity: $, rotation: r.rotate, ease: z }), 0);
                    }
            }
            if (16 == t) {
                var j = new punchgs.TimelineLite();
                f.add(punchgs.TweenLite.set(l, { position: "absolute", "z-index": 20 }), 0),
                    f.add(punchgs.TweenLite.set(s, { position: "absolute", "z-index": 15 }), 0),
                ...
                "on" == r.autoHeight && (G = n.height()),
                    l.find(".tp-half-one .defaultimg").wrap('<div class="tp-papercut" style="width:' + F + "px;height:" + G + 'px;"></div>'),
                    l.find(".tp-half-two .defaultimg").wrap('<div class="tp-papercut" style="width:' + F + "px;height:" + G + 'px;"></div>'),
                    ...
                    f.add(
                        punchgs.TweenLite.set(l.find(".tp-half-two"), { width: F, height: G, overflow: "hidden", zIndex: 15, position: "absolute", top: G / 2, left: "0px", transformPerspective: 600, transformOrigin: "center bottom" }),
                        0
                    ),
                    f.add(
                        punchgs.TweenLite.set(l.find(".tp-half-one"), { width: F, height: G / 2, overflow: "visible", zIndex: 10, position: "absolute", top: "0px", left: "0px", transformPerspective: 600, transformOrigin: "center top" }),
                        0
                    );
                ...
                f.add(punchgs.TweenLite.set(l.find(".tp-half-one"), { overflow: "hidden" }), 0),
                    f.add(
                        punchgs.TweenLite.fromTo(
                            l.find(".tp-half-one"),
                            y / 800,
                            { width: F, height: G / 2, position: "absolute", top: "0px", left: "0px", force3D: "auto", transformOrigin: "center top" },
                            { scale: ft, rotation: rt, y: 0 - G - G / 4, autoAlpha: 0, ease: T }
                        ),
                        0
                    ),
                    f.add(
                        punchgs.TweenLite.fromTo(
                            l.find(".tp-half-two"),
                            y / 800,
                            { width: F, height: G, overflow: "hidden", position: "absolute", top: G / 2, left: "0px", force3D: "auto", transformOrigin: "center bottom" },
                            {
                                scale: ct,
                                rotation: st,
                                y: G + G / 4,
                    ...
                    j.add(punchgs.TweenLite.set(d.find(".defaultimg"), { autoAlpha: 1 }), 0),
                    null != l.html() &&
                        f.add(
                            punchgs.TweenLite.fromTo(
                                s,
                                (y - 200) / 1e3,
                                { scale: pt, x: (r.width / 4) * dt, y: (G / 4) * ht, rotation: lt, force3D: "auto", transformOrigin: "center center", ease: z },
            ...
            if (
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                ...
                                { opacity: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: "auto", rotationY: 0, ease: T, delay: 0.06 * t }
                            ),
                            0
                        );
                    }),
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                ...
                                { autoAlpha: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: "auto", rotationY: 0, ease: T, delay: 0.06 * t }
                            ),
                            0
                        );
                    }),
                ...
                var ut = 90,
                    ...
                    gt = "center center ";
                1 == g && (ut = -90),
                    19 == t ? ((gt = gt + "-" + r.height / 2), ($ = 0)) : (gt += r.height / 2),
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        j.add(
                            punchgs.TweenLite.fromTo(
                                e,
                                y / 1e3,
                                { transformStyle: "flat", backfaceVisibility: "hidden", left: 0, rotationY: r.rotate, z: 10, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: gt, rotationX: ut },
                                { left: 0, rotationY: 0, top: 0, z: 0, scale: 1, force3D: "auto", rotationX: 0, delay: (50 * t) / 1e3, ease: T }
                            ),
                            0
                        ),
                            j.add(punchgs.TweenLite.to(e, 0.1, { autoAlpha: 1, delay: (50 * t) / 1e3 }), 0),
                            f.add(j);
                    }),
                    h.find(".slotslide").each(function (t) {
                        var e = jQuery(this),
                        ...
                        1 == g && (o = 90),
                            j.add(
                                punchgs.TweenLite.fromTo(
                                    e,
                                    y / 1e3,
                                    { transformStyle: "flat", backfaceVisibility: "hidden", autoAlpha: 1, rotationY: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: gt, rotationX: 0 },
                                    { autoAlpha: 1, rotationY: r.rotate, top: 0, z: 10, scale: 1, rotationX: o, delay: (50 * t) / 1e3, force3D: "auto", ease: z }
                                ),
                                0
                            ),
                            f.add(j);
                ...
                d.find(".slotslide").each(function (t) {
                    ...
                    f.add(
                        punchgs.TweenLite.fromTo(
                            e,
                            y / 1e3,
                            { left: wt, rotationX: 40, z: -600, opacity: $, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: gt, transformStyle: "flat", rotationY: ut },
                            { left: 0, rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: o, ease: T }
                        ),
                        0
                    );
                }),
                        ...
                        (z = punchgs.Power2.easeInOut),
                            f.add(
                                punchgs.TweenLite.fromTo(
                                    ...
                                    { opacity: 1, rotationX: 20, top: 0, z: -600, left: a, force3D: "auto", rotationY: i, delay: o, ease: z }
                                ),
                                0
                            );
                    });
                ...
                d.find(".slotslide").each(function (t) {
                    ...
                    f.add(
                        punchgs.TweenLite.fromTo(
                            e,
                            (2 * o) / 1e3,
                            { left: 0, transformStyle: "flat", rotationX: vt, z: 0, autoAlpha: 0, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: gt, rotationY: ut },
                            { left: 0, rotationX: 0, top: 0, z: 0, autoAlpha: 1, scale: 1, rotationY: 0, force3D: "auto", delay: o / 1e3, ease: T }
                        ),
                        0
                    );
                }),
                    1 != g
                        ? ((wt = -r.width), (ut = 90), 25 == t ? ((gt = "center top 0"), (vt = -ut), (ut = r.rotate)) : ((gt = "left center 0"), (vt = r.rotate)))
                        : ((wt = r.width), (ut = -90), 25 == t ? ((gt = "center bottom 0"), (vt = -ut), (ut = r.rotate)) : ((gt = "right center 0"), (vt = r.rotate))),
                    h.find(".slotslide").each(function (t) {
                        var e = jQuery(this);
                        f.add(
                            punchgs.TweenLite.fromTo(
                                e,
                                y / 1e3,
                                { left: 0, transformStyle: "flat", rotationX: 0, z: 0, autoAlpha: 1, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: gt, rotationY: 0 },
                                { left: 0, rotationX: vt, top: 0, z: 0, autoAlpha: 1, force3D: "auto", scale: 1, rotationY: ut, ease: z }
                            ),
                            0
                        );
                    });
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                e,
                                y / 1e3,
                                { left: mt, rotationX: r.rotate, force3D: "auto", opacity: $, top: 0, scale: 1, transformPerspective: 1200, transformOrigin: gt, rotationY: ut },
                                { left: 0, rotationX: 0, autoAlpha: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: (50 * t) / 500, ease: T }
                            ),
                            0
                        );
                    }),
                    ...
                    h.find(".slotslide").each(function (e) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                o,
                                y / 1e3,
                                { left: 0, rotationX: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformStyle: "flat", transformPerspective: 1200, transformOrigin: gt, rotationY: 0 },
                                { left: mt, rotationX: r.rotate, top: 0, scale: 1, rotationY: ut, delay: (50 * e) / 500, ease: z }
                            ),
                            0
                        ),
                            23 == t && f.add(punchgs.TweenLite.fromTo(o, y / 2e3, { autoAlpha: 1 }, { autoAlpha: 0, delay: (50 * e) / 500 + y / 3e3, ease: z }), 0);
                    });
            }
            return f;
        };
