...
!(function (t) {
    ...
    jQuery.extend(!0, e, {
        ...
        resizeThumbsTabs: function (t, e) {
            if ((t.navigation && t.navigation.tabs.enable) || (t.navigation && t.navigation.thumbnails.enable)) {
                var i = (jQuery(window).width() - 480) / 500,
                    ...
                    r = t.navigation.tabs,
                    o = t.navigation.thumbnails,
                    s = t.navigation.bullets;
                if ((a.pause(), (i = i > 1 ? 1 : 0 > i ? 0 : i), p(r) && (e || r.width > r.min_width) && n(i, a, t.c, r, t.slideamount, "tab"), p(o) && (e || o.width > o.min_width) && n(i, a, t.c, o, t.slideamount, "thumb"), p(s) && e)) {
                    var d = t.c.find(".tp-bullets");
                    d.find(".tp-bullet").each(function (t) {
                        var e = jQuery(this),
                            i = t + 1,
                            a = e.outerWidth() + parseInt(void 0 === s.space ? 0 : s.space, 0),
                            n = e.outerHeight() + parseInt(void 0 === s.space ? 0 : s.space, 0);
        ...
        manageNavigation: function (t) {
            ...
            p(t.navigation.bullets) &&
                ...
                b(t.c.find(".tp-bullets"), t.navigation.bullets)),
                p(t.navigation.thumbnails) && b(t.c.parent().find(".tp-thumbs"), t.navigation.thumbnails),
                p(t.navigation.tabs) && b(t.c.parent().find(".tp-tabs"), t.navigation.tabs),
                p(t.navigation.arrows) &&
                    ...
                    b(t.c.find(".tp-leftarrow.tparrows"), t.navigation.arrows.left),
                    b(t.c.find(".tp-rightarrow.tparrows"), t.navigation.arrows.right)),
                ...
                t.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function () {
                    ...
                    e.thumbs &&
                        jQuery.each(e.thumbs, function (t, e) {
                            (o = s === !1 ? t : o), (s = e.id === i || t === i ? !0 : s);
                        });
                    var d = o > 0 ? o - 1 : e.slideamount - 1,
                        l = o + 1 == e.slideamount ? 0 : o + 1;
                    if (r.enable === !0) {
                        var h = r.tmp;
                        if (
    ...
    var a = function (t, e) {
            var i = (t.hasClass("tp-thumbs") ? ".tp-thumbs" : ".tp-tabs", t.hasClass("tp-thumbs") ? ".tp-thumb-mask" : ".tp-tab-mask"),
                ...
                o = r.find(a),
                s = e.direction,
                d = "vertical" === s ? r.find(n).first().outerHeight(!0) + e.space : r.find(n).first().outerWidth(!0) + e.space,
                l = "vertical" === s ? r.height() : r.width(),
                h = parseInt(r.find(n + ".selected").data("liindex"), 0),
                p = l / d,
                u = "vertical" === s ? r.height() : r.width(),
                c = 0 - h * d,
                g = "vertical" === s ? o.height() : o.width(),
            ...
            p > 2 && ((v = 0 >= c - (f + d) ? (0 - d > c - (f + d) ? f : v + d) : v), (v = d > c - d + f + l && c + (Math.round(p) - 2) * d < f ? c + (Math.round(p) - 2) * d : v)),
                ...
                "vertical" !== s && r.width() >= o.width() && (v = 0),
                "vertical" === s && r.height() >= o.height() && (v = 0),
                t.hasClass("dragged") ||
                    ("vertical" === s ? o.data("tmmove", punchgs.TweenLite.to(o, 0.5, { top: v + "px", ease: punchgs.Power3.easeInOut })) : o.data("tmmove", punchgs.TweenLite.to(o, 0.5, { left: v + "px", ease: punchgs.Power3.easeInOut })),
                    o.data("offset", v));
        },
        n = function (t, e, i, a, n, r) {
            ...
            e.add(punchgs.TweenLite.set(o, c)), e.add(punchgs.TweenLite.set(s, { width: p + "px", height: u + "px" })), e.add(punchgs.TweenLite.set(d, { width: p + "px", height: u + "px" }));
            var g = s.find(".tp-" + r);
            return (
                g &&
        ...
        r = function (t) {
            ...
            return (
                ...
                (a || n) && t.deltaMode && (1 == t.deltaMode ? ((a *= o), (n *= o)) : ((a *= s), (n *= s))),
                a && !e && (e = 1 > a ? -1 : 1),
                n && !i && (i = 1 > n ? -1 : 1),
        ...
        s = function (t, i) {
            if ("on" === i.navigation.mouseScrollNavigation || "carousel" === i.navigation.mouseScrollNavigation) {
                ...
                t.on("mousewheel DOMMouseScroll", function (o) {
                    var s = r(o.originalEvent),
                    ...
                    return (
                        "carousel" != i.navigation.mouseScrollNavigation
                            ? ("reverse" !== i.navigation.mouseScrollReverse && ((c > 0 && s.pixelY > 0) || (g < jQuery(window).height() && s.pixelY < 0)) && (u = !0),
                              "reverse" === i.navigation.mouseScrollReverse && ((0 > c && s.pixelY < 0) || (g > jQuery(window).height() && s.pixelY > 0)) && (u = !0))
                            : (u = !1),
                        0 == u ? (o.preventDefault(o), !1) : void 0
                    );
                });
            }
        },
        ...
        l = function (t, a, n) {
            ...
            var o = (i || "Firefox" === e.get_browser(), t),
                s = "vertical" === a.navigation.thumbnails.direction || "vertical" === a.navigation.tabs.direction ? "none" : "vertical",
                l = a.navigation.touch.swipe_direction || "horizontal";
            (s = "swipebased" == n && "vertical" == l ? "none" : n ? "vertical" : s),
                ...
                o.swipetp({
                    ...
                    swipeStatus: function (i, n, o, s, h, p, u) {
                        ...
                        if (
                            ...
                            switch (((a.dragStartedOverSlider = !0), (s = o && o.match(/left|up/g) ? Math.round(-1 * s) : (s = Math.round(1 * s))), n)) {
                                case "start":
                                    ...
                                    break;
                                case "move":
                                    if (((r.slide_offset = "off" === r.infinity ? r.slide_globaloffset + s : e.simp(r.slide_globaloffset + s, r.maxwidth)), "off" === r.infinity)) {
                                        ...
                                        ("none" !== r.overpull && 0 !== r.overpull) || !(0 > b || b > a.slideamount - 1)
                                            ? b >= 0 && b <= a.slideamount - 1 && ((b >= 0 && s > r.overpull) || (b <= a.slideamount - 1 && s < r.overpull)) && (r.overpull = 0)
                                            : (r.overpull = s),
                                            (r.slide_offset =
                                                0 > b
                                                    ? r.slide_offset + (r.overpull - s) / 1.1 + Math.sqrt(Math.abs((r.overpull - s) / 1.1))
                                                    : b > a.slideamount - 1
                                                    ? r.slide_offset + (r.overpull - s) / 1.1 - Math.sqrt(Math.abs((r.overpull - s) / 1.1))
                                                    : r.slide_offset);
                                    }
                                    e.organiseCarousel(a, o, !0, !0);
                                    break;
                                case "end":
                                case "cancel":
                                    (r.slide_globaloffset = r.slide_offset), r.wrap.removeClass("dragged"), e.carouselToEvalPosition(a, o), (a.dragStartedOverSlider = !1), (a.dragStartedOverThumbs = !1), (a.dragStartedOverTabs = !1);
                            }
                        else {
                            if ((("move" !== n && "end" !== n && "cancel" != n) || a.dragStartedOverSlider || (!a.dragStartedOverThumbs && !a.dragStartedOverTabs)) && !("start" === n && c > 0 && (g > 0 || v > 0))) {
                                if ("end" == n && !m) {
                                    if (((a.sc_indicator = "arrow"), ("horizontal" == l && "left" == o) || ("vertical" == l && "up" == o))) return (a.sc_indicator_dir = 0), e.callingNewSlide(a, a.c, 1), !1;
                                    if (("horizontal" == l && "right" == o) || ("vertical" == l && "down" == o)) return (a.sc_indicator_dir = 1), e.callingNewSlide(a, a.c, -1), !1;
                                }
                            ...
                            switch (n) {
                                ...
                                case "move":
                                    if (Q >= L) return !1;
                                    (O = I + s), (O = O > 0 ? ("horizontal" === C ? O - j.width() * (((O / j.width()) * O) / j.width()) : O - j.height() * (((O / j.height()) * O) / j.height())) : O);
                                ...
                                case "cancel":
                                    if (m)
                                        return (
                                            ...
                                            (O = O > 0 ? 0 : O),
                                            (O = Math.abs(s) > k / 10 ? (0 >= s ? Math.floor(O / k) * k : Math.ceil(O / k) * k) : 0 > s ? Math.ceil(O / k) * k : Math.floor(O / k) * k),
                                            (O = "vertical" === C ? (O < 0 - (j.height() - S.height()) ? 0 - (j.height() - S.height()) : O) : O < 0 - (j.width() - S.width()) ? 0 - (j.width() - S.width()) : O),
                                            (O = O > 0 ? 0 : O),
        ...
        f = function (t, e) {
            var i = t.outerHeight(!0),
                a = (t.outerWidth(!0), void 0 == e.opt ? 0 : 0 == e.opt.conh ? e.opt.height : e.opt.conh),
                n =
                    "layergrid" == e.container
                        ? "fullscreen" == e.opt.sliderLayout
                            ? e.opt.height / 2 - (e.opt.gridheight[e.opt.curWinRange] * e.opt.bh) / 2
                            : "on" == e.opt.autoHeight || (void 0 != e.opt.minHeight && e.opt.minHeight > 0)
                            ? a / 2 - (e.opt.gridheight[e.opt.curWinRange] * e.opt.bh) / 2
                            : 0
                        : 0,
                r =
                    "top" === e.v_align
                        ? { top: "0px", y: Math.round(e.v_offset + n) + "px" }
                        : "center" === e.v_align
                        ? { top: "50%", y: Math.round(0 - i / 2 + e.v_offset) + "px" }
                        : { top: "100%", y: Math.round(0 - (i + e.v_offset + n)) + "px" };
            t.hasClass("outer-bottom") || punchgs.TweenLite.set(t, r);
        },
        m = function (t, e) {
            var i = (t.outerHeight(!0), t.outerWidth(!0)),
                a = "layergrid" == e.container ? ("carousel" === e.opt.sliderType ? 0 : e.opt.width / 2 - (e.opt.gridwidth[e.opt.curWinRange] * e.opt.bw) / 2) : 0,
                n =
                    "left" === e.h_align
                        ? { left: "0px", x: Math.round(e.h_offset + a) + "px" }
                        : "center" === e.h_align
                        ? { left: "50%", x: Math.round(0 - i / 2 + e.h_offset) + "px" }
                        : { left: "100%", x: Math.round(0 - (i + e.h_offset + a)) + "px" };
            punchgs.TweenLite.set(t, n);
        },
        b = function (t, e) {
            var i =
            ...
            if (
                ...
                o > a && "outer-left" !== e.position && "outer-right" !== e.position
                    ? (punchgs.TweenLite.set(t, { left: "0px", x: 0, maxWidth: a - 2 * r + "px" }), punchgs.TweenLite.set(d, { maxWidth: a - 2 * r + "px" }))
                    : (punchgs.TweenLite.set(t, { maxWidth: o + "px" }), punchgs.TweenLite.set(d, { maxWidth: o + "px" })),
                    s + 2 * r > n && "outer-bottom" !== e.position && "outer-top" !== e.position
                        ? (punchgs.TweenLite.set(t, { top: "0px", y: 0, maxHeight: l + h + (n - 2 * r) + "px" }), punchgs.TweenLite.set(d, { maxHeight: l + h + (n - 2 * r) + "px" }))
                        : (punchgs.TweenLite.set(t, { maxHeight: s + "px" }), punchgs.TweenLite.set(d, { maxHeight: s + "px" })),
                    "outer-left" !== e.position && "outer-right" !== e.position && ((l = 0), (h = 0)),
                    e.span === !0 && "vertical" === e.direction
                        ? (punchgs.TweenLite.set(t, { maxHeight: l + h + (n - 2 * r) + "px", height: l + h + (n - 2 * r) + "px", top: 0 - l, y: 0 }), f(d, e))
                        : e.span === !0 && "horizontal" === e.direction && (punchgs.TweenLite.set(t, { maxWidth: "100%", width: a - 2 * r + "px", left: 0, x: 0 }), m(d, e));
            }
        },
        w = function (t, e, i, a) {
            ...
            var s = t.find(".justaddedbullet"),
                ...
                l = s.outerWidth() + parseInt(void 0 === e.space ? 0 : e.space, 0),
                h = s.outerHeight() + parseInt(void 0 === e.space ? 0 : e.space, 0);
            "vertical" === e.direction
                ? (s.css({ top: (d - 1) * h + "px", left: "0px" }), n.css({ height: (d - 1) * h + s.outerHeight(), width: s.outerWidth() }))
                : (s.css({ left: (d - 1) * l + "px", top: "0px" }), n.css({ width: (d - 1) * l + s.outerWidth(), height: s.outerHeight() })),
                s.find(".tp-bullet-image").css({ backgroundImage: "url(" + a.thumbs[i.index()].src + ")" }),
                s.data("liref", r),
                s.click(function () {
